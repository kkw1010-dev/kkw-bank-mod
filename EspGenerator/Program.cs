    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var dunning = new Dictionary<string, string[]>
            {
                ...
                {
                    "위대한 발그루프의 행정관\n\n뵐 수 있기를 기대했으나, 영지 밖에서 귀하의 위대한 대업에 대한 소문만 전해 들을 뿐이군요.\n\n지금 화이트런은 제국과 스톰클로크의 갈등 속에서 홀드를 지켜내기 위해 재정적으로 매우 엄중한 전시 상황을 겪고 있습니다. 귀하에게 드래곤즈리치 금고의 자금을 내어드린 것은, 영주님께서 용맹한 모험가이자 세상을 구할 드래곤본으로써의 여정에 도움이 될 것이라 온전히 믿으셨기 때문입니다.\n[pagebreak]\n우리가 시정잡배 고리대꾼 처럼 무례하게 빚을 추궁하려는 것은 아닙니다. 다만, 화이트런이 풍전등화와 같은 전쟁의 기로에 서 있는 지금, 귀하마저 우리의 신뢰를 저버리고 지원금을 방치한다면 야를의 선의는 설 자리를 잃게 됩니다.\n\n부디 귀하의 명예와 우리 사이의 신뢰를 기억해 주십시오. 이 서신을 보거든 드래곤즈리치로 직접 저를 찾아와 야를의 호의에 대한 보답을 깨끗이 매듭지어 주시길 부탁드립니다.",
